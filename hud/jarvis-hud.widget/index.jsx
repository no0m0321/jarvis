...
export const render = ({ output }) => {
  ...
  return (
    <div className={`hud hud-${effectiveState}`}>
...
export const className = `
  ...
  &.hud-analyzing {
    ...
    box-shadow: 0 0 48px rgba(255, 123, 0, 0.55), inset 0 0 28px rgba(255, 123, 0, 0.12)
  }
  &.hud-listening {
  ...
  &.hud-speaking {
    ...
    box-shadow: 0 0 40px rgba(255, 215, 0, 0.45), inset 0 0 24px rgba(255, 215, 0, 0.1)
  }
  ...
  @keyframes hud-pulse {
    0%, 100% { box-shadow: 0 0 32px rgba(0, 255, 229, 0.32), inset 0 0 24px rgba(0, 255, 229, 0.06) }
    50% { box-shadow: 0 0 56px rgba(0, 255, 229, 0.6), inset 0 0 36px rgba(0, 255, 229, 0.18) }
  }
  @keyframes hud-blink {
    0%, 100% { opacity: 1 }
    50% { opacity: 0.4 }
